...
* Objective
  ...
  + To check the Functionality of Labs slot in the Analytics division. 
...
* Test Steps
  ...
  +  Check whether the number of the labs is displaying on the landing
     page or not.      
 
* Expected result

  +  Number of the labs should be displayed on the landing page.
